  ...
  return (
    <section className="relative">
      <div className="absolute flex flex-col h-full 2xl:pt-[5%] 2xl:pl-[25%] 2xl:gap-[20px] xl:pt-[8%] xl:pl-[30%] lg:pt-16 lg:pl-[25%] md:pt-14 md:pl-[25%] sm:pt-10 sm:pl-[25%]  pt-5 pl-5">
        <p className="Chela-One 2xl:text-[80px] xl:text-[50px] lg:text-[45px] md:text-[30px] sm:text-[25px] text-[20px] ">About</p>
        <p className="hero-title 2xl:text-[140px] xl:text-[110px] text-[#007A2A] lg:text-[100px] md:text-[60px] sm:text-[50px] text-[30px]">DinoDao</p>
